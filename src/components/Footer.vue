        ...
        <div class="container">
            <div class="footer__nav">
                <ul class="footer__menu-list">
                    <li>
                        <a href="#!" class="footer__menu-item">Другие популярные разделы</a>
                        <ul class="footer__menu-second">
                            <li><a href="#!">Коворкинги в Москва Сити</a></li>
                            <li><a href="#!">Коворкинги Екатеринбурга</a></li>
                            <li><a href="#!">Коворкинги Новосибирска</a></li>
                            <li><a href="#!">Коворкинги Казани</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#!" class="footer__menu-item">Виды коворкингов</a>
                        <ul class="footer__menu-second">
                            <li><a href="#!">Кабинет психолога</a></li>
                            <li><a href="#!">Бьюти-коворкинги</a></li>
                    ...
                    <li>
                        <a href="#!" class="footer__menu-item">Услуги</a>
                        <ul class="footer__menu-second">
                            <li><a href="#!">Каталог коворкингов</a></li>
            ...
            <div class="footer__info">
                <svg width="84" height="37" viewBox="0 0 84 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="url(#paint0_linear_6023_344)" fill-opacity="0.8" />
                    <path
                        ...
                        fill="url(#paint1_linear_6023_344)" fill-opacity="0.8" />
                    <defs>
                        <linearGradient id="paint0_linear_6023_344" x1="-1.21739e-07" y1="21.5" x2="118.626" y2="24.1553"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#1624EC" />
                            <stop offset="0.664583" stop-color="#777FED" />
                            <stop offset="1" stop-color="#E9E9EF" />
                        </linearGradient>
                        <linearGradient id="paint1_linear_6023_344" x1="70" y1="17" x2="88.6502" y2="17.0782"
                            gradientUnits="userSpaceOnUse">
                            <stop stop-color="#1624EC" />
                            <stop offset="0.664583" stop-color="#777FED" />
                            <stop offset="1" stop-color="#E9E9EF" />
                ...
                <div class="">
                    <p>Почта для рекламых предложений:</p>
                    <a href="#!" class="footer__link">advert@place2.ru</a>
                </div>
            </div>
            <div class="copyright">© Place2 2024. Все права защищены.</div>
            <div class="privacy-policy footer__link">Политика конфиденциальности</div>
        </div>
    </footer>
</template>
