...
import SearchCity from '../Header/SearchCity.vue';
...
<template>
   <div :class="{'filters-wrapper' : true, 'open' : isFiltersOpen}">
    <div class="filters-sticky">
        ...
        <div class="filter">
            ...
            <div class="filter__search-wrapper">
                <p class="filter__search-title" @click="isSearchCityOpen = true">Москва</p>
    ...
    <SearchCity 
        ...
        :closeSearchCity="()=>isSearchCityOpen = false"/>
   </div>
</template>
