...
const isHeaderLocationOpen = ref(false);
...
function openSearchInput() {
  ...
  document.addEventListener("click", (event) => {
    ...
    if (
      ...
      target.classList.contains("header__search-wrapper") ||
      target.classList.contains("header__search-btn")
    ) {
      return;
    } else {
...
const selectLocationCity = (classList) => {
  isHeaderLocationOpen.value = true;
  document.addEventListener("click", (event) => {
    if (!event.target.classList.contains(classList)) {
      isHeaderLocationOpen.value = false;
    }
  });
}
    ...
    <div class="header__top">
      <div class="container">
        <div class="header__top-main">
            ...
            <router-link to="/">
              ...
              >
                <path
                  ...
                  fill="url(#paint0_linear_6001_226)"
                  fill-opacity="0.8"
                />
                <path
                  ...
                  fill="url(#paint1_linear_6001_226)"
                  fill-opacity="0.8"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_6001_226"
                    x1="-1.21739e-07"
                    y1="21.5"
                    x2="118.626"
                    y2="24.1553"
          ...
          <div
            :class="{ header__location: true, active: isHeaderLocationOpen }"
            @click.stop="selectLocationCity('header__location')"
          >
            <span>Москва</span>

            <div class="header__location-result">
        ...
        <div class="header__top-buttons">
          <div class="header__search-wrapper">
            <input
              type="text"
              :class="{ 'header__search-input': true, active: isActiveSearch }"
              placeholder="Поиск"
            />
            ...
            <button class="header__search-btn" @click="openSearchInput">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" >
                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.2 1.8C4.21766 1.8 1.8 4.21766 1.8 7.2C1.8 10.1823 4.21766 12.6 7.2 12.6C8.69142 12.6 10.0402 11.9966 11.0184 11.0184C11.9966 10.0402 12.6 8.69142 12.6 7.2C12.6 4.21766 10.1823 1.8 7.2 1.8ZM0 7.2C0 3.22355 3.22355 0 7.2 0C11.1764 0 14.4 3.22355 14.4 7.2C14.4 8.86346 13.835 10.3962 12.8878 11.615L17.7364 16.4636C18.0879 16.8151 18.0879 17.3849 17.7364 17.7364C17.3849 18.0879 16.8151 18.0879 16.4636 17.7364L11.615 12.8878C10.3962 13.835 8.86346 14.4 7.2 14.4C3.22355 14.4 0 11.1764 0 7.2Z" fill="#273266"/>
              </svg>
            </button>
          ...
          <div class="log-in-buttons" v-else>
            <router-link to="/registration" class="btn btn_blue">Зарегистрироваться</router-link>
            
            <div class="authorization">
              <button class="btn btn_border log-in" @click="logIn">Войти</button>
              <div :class="{'authorization__inner': true, 'log-in': true, 'active' : isAuthorization}">
                <h3 class="authorization__title log-in">Введите номер телефона чтобы войти или зарегистрироваться</h3>
                <input type="tel" class="authorization__input log-in" placeholder="+7 (___) ___-__-__">
                <button class="btn btn_gradient log-in" @click="isUser = true">Войти</button>
                <p class="log-in">Нажимая кнопку "Войти", Вы соглашаетесь c условиями <a href="#!">политики конфиденциальности</a></p>
              </div>
            </div>
          </div>
          ...
          <ul class="header__menu-list">
            <li class="header__menu-item _with-children">
              ...
              <div class="header__menu-second">
                <ul class="header__menu-filters" @mouseleave="isHovered = true">
                  <li class="header__menu-filter">
                    <a
                      href="#!"
                      class="header__menu-filter-title"
                      @mouseover="isHovered = false"
                      >Все коворкинги Москвы</a
                    >
                    <ul
                      :class="{
                        'header__second-menu-items': true,
                        _hovered: isHovered,
                      }"
                    >
                      <li class="header__second-menu-item">
                        <a href="#!" class="header__second-menu-title"
                          >Рабочее место</a
                        >
                        <ul>
                          <li class="header__third-menu">
                            <a href="#!">Коворкинг F2.CITY</a>
                          </li>
                          <li class="header__third-menu">
                            <a href="#!">SOK Рыбаков Тауэр</a>
                          </li>
                          <li class="header__third-menu">
                            <a href="#!">CEO Rooms Крылья</a>
                          </li>
                          <li class="header__third-menu">
                            <a href="#!">Коворкинг officeless</a>
                          </li>
                        </ul>
                      </li>
                      <li class="header__second-menu-item">
                  ...
                  <li class="header__menu-filter">
                    <a href="#!" class="header__menu-filter-title"
                      >Коворкинги по станции метро</a
                    >
                  ...
                  <li class="header__menu-filter">
                    <a href="#!" class="header__menu-filter-title"
                      >Коворкинги Москва-Сити</a
                    >
                  </li>
                  <li class="header__menu-filter">
                    <a href="#!" class="header__menu-filter-title"
                      >Коворкинги Московской области</a
                    >
                    <ul class="header__second-menu-items">
                      <li class="header__second-menu-item">
                        <a href="#!" class="header__second-menu-title"
...
.header__location {
  ...
  &.active .header__location-result {
...
.header__menu-filter > a {
  ...
  &:hover + .header__second-menu-items {
    display: grid;
  }
}
